        ...
        {tab==='dashboard'?<>
          ...
          <section className="hf-grid2 hf-dashboard-main-grid">
            ...
            <div className="hf-panel hf-chart-panel">
              ...
              <div className="hf-status-chart" style={{display:"grid",gridTemplateColumns:"190px minmax(0,1fr)",alignItems:"center",gap:"28px",marginTop:"20px"}}>
                ...
                <div className="hf-chart-legend" style={{display:"flex",flexDirection:"column",gap:"0",minWidth:0}}>
                  {statuses.map((s) => {
                    ...
                    return (
                      <div className="hf-chart-legend-row" key={s} style={{display:"grid",gridTemplateColumns:"minmax(0,1fr) 45px 45px",alignItems:"center",minHeight:"42px",padding:"4px 0",borderBottom:"1px solid #edf1f5"}}>
                        <div className="hf-chart-legend-label" style={{display:"flex",alignItems:"center",gap:"9px"}}>
            ...
            <div className="hf-panel hf-hours-chart-panel">
              ...
              <div className="hf-hours-summary">
                <span className="hf-dashboard-eyebrow">TOTAL PLANEJADO</span>
                <div className="hf-big-number">
                  {dashboard.totalHours}h
                </div>
                <p className="hf-muted">
                  Horas totais das demandas no período selecionado.
                </p>
              </div>
                      ...
                      style={{
                        width:`${
                          dashboard.totalHours
                            ? Math.min(
                                100,
                                (dashboard.analysisHours / dashboard.totalHours) * 100
                              )
                            : 0
                        }%`
                      }}
                      ...
                      style={{
                        width:`${
                          dashboard.totalHours
                            ? Math.min(
                                100,
                                (dashboard.requiredHours / dashboard.totalHours) * 100
                              )
                            : 0
                        }%`
                      }}
                      ...
                      style={{
                        width:`${
                          dashboard.totalHours
                            ? Math.min(
                                100,
                                (dashboard.finishedHours / dashboard.totalHours) * 100
                              )
                            : 0
                        }%`
                      }}
          ...
          <section className="hf-panel hf-dashboard-demand-panel">
            <div className="hf-panel-title">
              <div>
                <span className="hf-dashboard-eyebrow">ACOMPANHAMENTO</span>
...
.hf-donut{
  ...
  background:conic-gradient(
    ...
    #3b82f6 70deg 90deg,
    #8b5cf6 90deg 100deg,
    #06b6d4 100deg 100deg,
    #f59e0b 100deg 100deg,
    #22c55e 100deg 360deg
  ) !important;
...
.hf-chart-legend-row{
  ...
  transition:background .15s ease,padding .15s ease !important;
}
...
.hf-donut-segment{
  cursor:pointer !important;
  transition:stroke-width .2s ease,filter .2s ease,opacity .2s ease !important;
}

.hf-donut-segment:hover{
  stroke-width:22 !important;
  filter:drop-shadow(0 3px 6px rgba(15,23,42,.25)) !important;
}
...
.hf-donut-segment:hover{
  ...
  filter:drop-shadow(0 3px 7px rgba(15,23,42,.25)) !important;
}
/* =========================================================
...
.hf-dashboard-secondary > *:hover{
  transform:translateY(-2px) !important;
  box-shadow:0 8px 20px rgba(15,23,42,.07) !important;
}

.hf-dashboard-secondary > *:nth-child(1){
  border-left:4px solid #22c55e !important;
}

.hf-dashboard-secondary > *:nth-child(2){
  border-left:4px solid #ef4444 !important;
}

.hf-dashboard-secondary > *:nth-child(3){
  border-left:4px solid #f59e0b !important;
}

.hf-dashboard-secondary > *:nth-child(4){
  border-left:4px solid #3b82f6 !important;
}

.hf-dashboard-secondary > *:nth-child(5){
...
.hf-hours-chart-panel .hf-panel-title{
...
.hf-donut-dynamic::after{
  ...
  border-radius:50% !important;
  background:#fff !important;
  box-shadow:0 0 0 1px #f0f3f7 !important;
  z-index:2 !important;
  pointer-events:none !important;
}

.hf-donut-dynamic .hf-donut-segment{
  cursor:pointer !important;
  pointer-events:stroke !important;
  opacity:1 !important;
  transition:stroke-width .2s ease,opacity .2s ease,filter .2s ease !important;
}

.hf-donut-dynamic .hf-donut-segment:hover{
...
.hf-donut-dynamic .hf-donut-center{
  position:absolute !important;
  inset:0 !important;
  z-index:3 !important;
  display:flex !important;
...
.hf-donut-dynamic .hf-donut-center strong{
...
.hf-donut-dynamic .hf-donut-center span{
...
/* =========================================================
   CORREÇÃO FINAL - GRÁFICO DE STATUS
   ========================================================= */
...
.hf-donut-dynamic .hf-donut-svg circle:first-child{
...
/* Tooltip visual da legenda */
.hf-chart-legend-row:hover .hf-chart-legend-label span:last-child{
  color:#18243b !important;
  font-weight:600 !important;
}
