  ...
  Filtros
      ...
      <option key={period} value={period}>
        ...
        {tab==='dashboard'?<>
          <section className="hf-dashboard-header">
          ...
          </section>          <section className="hf-dashboard-kpis hf-dashboard-period-cards"
            style={{
              display:"grid",
            ...
            <Card
              title="Total do mês"
              value={dashboardLoading?'…':`${Number(dashboard.analyzedHours||0)+Number(dashboard.finishedHours||0)}h`}
              icon={<Clock3/>}
            />

          </section>

          <section className="hf-dashboard-secondary hf-dashboard-general-cards"
            style={{
              display:"grid",
            ...
            <div className="hf-dashboard-mini">
              <span className="hf-dashboard-mini-label">Total de demandas</span>
              <strong>{dashboardLoading?'…':dashboard.totalDemands}</strong>
            </div>
...
/* =========================================================
   CARDS GERAIS DA DASHBOARD
   ========================================================= */

.hf-dashboard-general-cards{
  align-items:stretch;
}

.hf-dashboard-general-cards .hf-dashboard-mini{
  background:#fff;
...
.hf-dashboard-general-cards .hf-dashboard-mini-label{
  display:block;
  font-size:13px;
  line-height:1.3;
  color:#7b8798;
...
.hf-dashboard-general-cards .hf-dashboard-mini strong{
  display:block;
  font-size:24px;
  line-height:1.1;
  color:#16233b;
