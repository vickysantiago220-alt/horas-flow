...
const dashboardDemands=useMemo(()=>{
  ...
  return <div className="hf-app">
    ...
    <aside className={`hf-sidebar ${mobileMenu?'open':''}`}>
      <div className="hf-brand-logo"><img src="/saphire-logo-sem-fundo.png" alt="Saphire Sheet" /><span>Saphire Sheet</span></div>
      <nav>
